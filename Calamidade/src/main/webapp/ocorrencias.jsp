...
<script>
    document.querySelectorAll(".alterar-link").forEach(function (link) {
        link.addEventListener("click", function (event) {
            ...
            var latitude = row.querySelector("td:nth-child(9)").textContent;
            var longitude = row.querySelector("td:nth-child(10)").textContent;
            var aberto = row.querySelector("td:nth-child(11)").textContent;
